...
namespace InitialGeometry
{
	...
	EdgeMesh makeCircleMesh(const Vec2R& center, Real radius, Real divisions)
	{
	...
	EdgeMesh makeSquareMesh(const Vec2R& center, const Vec2R& scale)
	{
		std::vector<Vec2R> verts;
		std::vector<Vec2i> edges;
	...
	EdgeMesh makeDiamondMesh(const Vec2R& center, const Vec2R& scale)
	{
		std::vector<Vec2R> verts;
		std::vector<Vec2i> edges;
